...
import pic1 from '../../Assets2/Front_pic.png';
import pic2 from '../../Assets2/about_pic2.jpg';
import pic3 from '../../Assets2/about_pic3.jpg';
import './About.css';
...
const getPosition = (i) => {
  ...
  // right side
  if (i === current + 1) return "right";
  if (current === images.length - 1 && i === 0) return "right";
